...
from homeassistant.components.sensor import DEVICE_CLASSES, PLATFORM_SCHEMA, SensorEntity
...
PLATFORM_SCHEMA = PLATFORM_SCHEMA.extend(
    {
        ...
        vol.Optional(CONF_UNIT_OF_MEASUREMENT, default=UnitOfTemperature.CELSIUS): cv.string,
...
class OnewireSensor(SensorEntity):
